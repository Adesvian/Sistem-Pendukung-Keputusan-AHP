    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages-admin\alternatif\data-alternatif.php">
              <span class="menu-title">Data Alternatif Pabrik</span>
              <i class="mdi mdi-database menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages-admin\p_kriteria\p-kriteria.php">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                if (getJumlahKriteria() > 0) {
                  for ($i = 0; $i <= (getJumlahKriteria() - 1); $i++) { ?>
                    <li class="nav-item"> <a class="nav-link" href="pages-admin\kelola-data\pembobotan.php?c=<?php echo ($i + 1) ?>"> <?php echo getKriteriaNama($i) ?></a></li>
                  <?php } ?>
                <?php } ?>
              </ul>
            </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages-admin\result\result.php">

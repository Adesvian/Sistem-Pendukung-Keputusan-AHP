...
if (isset($_POST['tambah'])) {
    ...
    header('Location: ../../pages-admin/' . $jenis . '/data-' . $jenis . '.php');
}
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../hasil/hasil.php">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Tambah Data <?php echo $jenis ?> Pabrik</h3>
                    </div>
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nama <?php echo $jenis ?> Pabrik</h4>
                                <form class="form-inline" method="post" action="tambah-data.php">
                                    <input type="text" name="nama" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Nama <?php echo $jenis ?>" required>
                                    <input type="hidden" name="jenis" value="<?php echo $jenis ?>">
                                    <button type="submit" name="tambah" class="btn btn-gradient-primary mb-2">Tambah</button>
                                </form>
                            </div>
                        </div>
                    </div>

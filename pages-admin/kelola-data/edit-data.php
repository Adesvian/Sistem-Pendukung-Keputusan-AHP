            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Edit Data <?php echo $jenis ?> Pabrik</h3>
                    </div>
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nama <?php echo $jenis ?> Pabrik</h4>
                                <form class="form-inline" method="post" action="edit-data.php">
                                    <input type="text" name="nama" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Nama <?php echo $jenis ?>" value="<?php echo $nama ?>" required>
                                    <input type="hidden" name="jenis" value="<?php echo $jenis ?>">
                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                    <button type="submit" name="update" class="btn btn-gradient-primary mb-2">Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
